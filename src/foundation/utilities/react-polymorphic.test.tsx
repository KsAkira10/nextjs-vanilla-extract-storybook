...
import type * as Polymorphic from './react-polymorphic';
...
type ExtendedButtonButtonOwnProps = Omit<Polymorphic.OwnProps<typeof Button>, keyof ExtendedButtonOwnProps | 'another'>;
